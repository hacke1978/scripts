...
% sessionDir = {'hermes_20171113_fixation-color-masksize_78'};
...
%  ,...
% sessionDir = {
% 'hermes_20170522_fixation-color-masksize_43',...
% 'hermes_20170522_fixation-color-masksize_43b',...
% };
% sessionDir = {'hermes_20170519_fixation-color-masksize_42'};
sessionDir = dir(fullfile(dataDir, '*2018*'));
sessionDir = {sessionDir.name};
sessionDir(1:end-9) = [];
sessionDir(end-3:end) = [];
%% Functions
failedSessions = [];
