...
if ~isfield(cfg, 'calcLocation');  cfg.calcLocation = 'slurm';     end
...
switch cfg.calcLocation
    case 'slurm'
        out = slurmfun(@extract_spikes, allCfg, 'partition', '8GBS', ...
                        'useUserPath', true, 'waitForToolboxes', {'signal_toolbox'});
    case 'local'
