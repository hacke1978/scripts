...
sesType = 'NatImFix'; %'NatImFix'; % 'NatImSEQ' 'grating-ori' 'rfmapping-bar'
...
% sessionList = {'hermes_20171207_fixation-naturalim_96'};
%% Functions
cfg = [];
n = 0;
for ses = 1:length(sessionList)
    ...
    cfg{n}.runPSTH = false;
    cfg{n}.runTimelockLFP = false;
    cfg{n}.runTimelockMUAX = false;
